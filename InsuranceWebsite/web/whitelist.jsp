			...
			<div class="span9">
				...
				<div class="stat-container">
					...
					<div class="stat-holder">						
						<div class="stat">							
							<span><%=ClientDAO.getWhite().size()%></span>						
							White List						
						</div> <!-- /stat -->						
					</div> <!-- /stat-holder -->
				...
				<div class="widget widget-table">
					...
					<div class="widget-content">
						...
						<table class="table table-striped table-bordered">
							...
							<tbody>
								<%
                                                                    ArrayList<White> whiteList = ClientDAO.getWhite();
                                                                    for(White w : whiteList){
                                                                %>
                                                                <tr>
                                                                    <td><%=w.getNric()%></td>
                                                                    <td><%=w.getLicencePlate()%></td>
                                                                    <td><%=w.getName()%></td>
                                                                    <td><%=w.getVehicleType()%></td>
                                                                    <td><%=w.getNewPremium()%></td>
