...
<html>
    ...
    <body>
        <div class="container" align="center">
            <h2>Top-K Students With Most App Usage (Given An App Category)</h2><br/>
            <%
            ...
            <div class="container" id="results" align="center">
                    <%
                        ...
                        if (results != null) {
                            ...
                            //out.println("</ul>");
                            if (results.size() == 0) {
                                out.println("<p style='font-size: 18px'>There are no students who have used apps belonging to the specified App Category during the specified window</p>");
                            } else {
                                out.println("<div class ='row'> <div class ='col-md-6 col-md-offset-3'> <table class='table table-bordered table-striped'>");
                                out.println("<thead><tr><th><center>Rank</center></th><th>Name [MacAddress]</th><th><center>Duration (seconds)</center></th></tr></thead><tbody>");
                                int counter = 1;
                                for (int i = 0; i < results.size(); i++) {
                                    ...
                                    for (int j = 0; j < line.size(); j++) {
                                        ...
                                        currentLine += currentResult.getName() + " [" + currentResult.getIdentifierName() + "]";
                                        counter++;
                                    }
